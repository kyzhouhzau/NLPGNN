...
class FullTokenizer(object):
    ...
    @classmethod
    def albert_scratch(cls, vocab_file, do_lower_case, spm_model_file):
        return FullTokenizer(vocab_file, do_lower_case, spm_model_file)

    @classmethod
    def bert_scratch(cls, vocab_file, do_lower_case):
        return FullTokenizer(vocab_file, do_lower_case, spm_model_file=None)


    def tokenize(self, text):
        if self.sp_model:
            split_tokens = encode_pieces(self.sp_model, text)
        else:
            split_tokens = []
